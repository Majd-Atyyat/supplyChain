                            ...
                            <Tab.Container defaultActiveKey="Import">   
                                        ...
                                        <div className="btn-group">
                                          ...
                                          <Nav as="ul" className="nav nav-pills" id="pills-tab" role="tablist">
                                            <Nav.Item as="li" className="nav-item btn-group" role="presentation">
                                              <Nav.Link as="button" type="button" className="btn effect mx-2 nav-link" id="pills-home-tab" eventKey="Import">
                                            ...
                                            <Nav.Item as="li" className="nav-item btn-group" role="presentation">
                                                <Nav.Link as="button" className="btn  mx-2 effect nav-link" id="pills-profile-tab" eventKey="Social">
                                                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <Nav.Item as="li" className="nav-item btn-group" role="presentation">
                                                <Nav.Link as="button" className="btn  mx-2 effect nav-link" id="pills-contact-tab" eventKey="Promotion">
                                        ...
                                        <div className="message" key={ind}>
                                          <div>
                                            <div className="d-flex message-single">
                                              ...
                                              <div className="ms-2">
                                                <label className="bookmark-btn"><input type="checkbox" /><span className="checkmark" ></span></label>
                                              </div>
                                            </div>
                                            <Link to="/email-read" className="col-mail col-mail-2">
                                              <div className="hader">UI Design Beginner</div>
                                              <div className="subject">
                                                  working time in this pandemic<span> Lorem ipsum dolor sit amet, consectetur adipiscing elit</span>
                                              </div>
                                              <div className="date">11:49 AM</div>
                                            </Link>
                                            <div className="icon">
                                              <Link to={"#"}><svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              <Link to={"#"} className="ms-2"><svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div className="row">
                                <div className="col-12 ps-3">
                                  <div className="d-sm-flex text-center justify-content-between align-items-center pagination">
