                           ...
                           <table className="table table-sm mb-0 table-striped student-tbl">
                              ...
                              <tbody id="customers">
                                 ...
                                 <tr className="btn-reveal-trigger">
                                    ...
                                    <td className="py-2">11/07/2022</td>
                                    <td className="py-2 text-end">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
                                    ...
                                    <td className="py-2">05/04/2021</td>
                                    <td className="py-2 text-end">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
                                    ...
                                    <td className="py-2">05/04/2023</td>
                                    <td className="py-2 text-end">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
                                    ...
                                    <td className="py-2">17/03/2021</td>
                                    <td className="py-2 text-end">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
                                 ...
                                 <tr className="btn-reveal-trigger">
                                    ...
                                    <td className="py-2">15/04/2023</td>
                                    <td className="py-2 text-end">{drop}</td>
                                 </tr>
                                 <tr className="btn-reveal-trigger">
                                    <td className="py-2 customer_shop_single">
